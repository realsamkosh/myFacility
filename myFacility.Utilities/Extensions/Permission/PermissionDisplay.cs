...
namespace myFacility.Utilities.Extensions.Permission
{
    ...
    {
        public PermissionDisplay(string groupName, string name, string description, myFacilityPermissions permission
            /*string moduleName*/)
        {
        ...
        /// </summary>
        public myFacilityPermissions Permission { get; private set; }
        /// <summary>
        ...
        public static List<PermissionDisplay> GetPermissionsToDisplay(Type enumType)
        {
            ...
            foreach (var permissionName in Enum.GetNames(enumType))
            {
                ...
                var permission = (myFacilityPermissions)Enum.Parse(enumType, permissionName, false);
